...
describe("UpdateProfileForm Tests", () => {
    ...
    test("Can save and cancel test", async () => {
        const showProfile = jest.fn(() =>
            componentRender(<UpdateProfileForm show />),
        )
    ...
    test("Revert data on edit cancel test", async () => {
        ...
        expect(screen.getByTestId("UpdateProfileForm.Username")).toHaveValue(
            "admin",
        )
        // clear input
        ...
        await userEvent.type(
            screen.getByTestId("UpdateProfileForm.Username"),
            "guest",
        )
    ...
    test("Error on saving empty input test", async () => {
        ...
        // check result
        expect(
            screen.getByTestId("UpdateProfileForm.ValidateErrors.SubTitle"),
        ).toBeInTheDocument()
    })
