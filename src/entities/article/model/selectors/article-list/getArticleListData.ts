...
export const getArticlesPageLimit = (state: StateSchema) =>
    state.articles?.limit || LIST_VIEW_PER_PAGE
export const getArticlesHasMore = (state: StateSchema) =>
    state.articles?.hasMore
export const getArticlesMounted = (state: StateSchema) =>
    state.articles?._mounted
...
export const getArticlesSort = (state: StateSchema) =>
    state.articles?.sort ?? ArticleSortType.CREATED
export const getArticlesOrder = (state: StateSchema) =>
    state.articles?.order ?? ArticleOrderType.ASC
